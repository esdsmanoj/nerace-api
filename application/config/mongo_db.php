...
$mongoClient = new MongoDB\Client("mongodb://admin:supp0rt#123@115.124.124.132:27017/");
$databaseName = "famrut_commodity";
$predictionCollectionName = "tbl_price_prediction_data";
$historicalCollectionName = "tbl_maharashtra";
*/

$config['mongo_db']['active'] = 'default';

$config['mongo_db']['default']['no_auth'] = true;
$config['mongo_db']['default']['hostname'] = '115.124.124.132';
$config['mongo_db']['default']['port'] = '27017';
$config['mongo_db']['default']['username'] = 'admin';
$config['mongo_db']['default']['password'] = 'supp0rt#123';
$config['mongo_db']['default']['database'] = 'famrut_commodity';
